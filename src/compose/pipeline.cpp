...
//     AbstractDataTypePtr queried = DummyDS::make(getUniqueName("_query_" + last_output.getName()), "auto", last_output);
...
//                 AbstractDataTypePtr queried = DummyDS::make(getUniqueName("_query_" + in.getName()), "auto", in);
