...
int main() {
    ...
    using AType = annot::MatrixGlobalToSharedFlat;
    using BType = annot::MatrixGlobalToSharedFlat;
    using CType = annot::MatrixGlobalToGlobal;

    using CTypeReg = annot::MatrixQueryRegNoVector;
    ...
    auto obj_reg = CTypeReg("C_reg", m, n, block_size, false);
